...
def parse_args(args):
    ...
    parser.add_argument("--train-data-mix-weights",
        type=float,
        nargs="+",
        default=None,
        help=(
    ...
    parser.add_argument("--train-num-samples",
        type=int,
        default=None,
        help="Number of samples in dataset. Required for webdataset if not available in info file.",
    )
    parser.add_argument("--val-num-samples",
        type=int,
        default=None,
    ...
    parser.add_argument("--disable-buffer",
        action="store_true",
        default=False,
    ...
    parser.add_argument("--workers",
     type=int, default=1, help="Number of dataloader workers per GPU."
    )
    parser.add_argument("--batch-size",
         type=int, default=64, help="Batch size per GPU."
    )
    parser.add_argument("--epochs",
         type=int, default=32, help="Number of epochs to train for."
    )
    ...
    parser.add_argument("--decoupled-wd", type=float, default=None, help="Decoupled weight decay.")
    ...
    parser.add_argument("--log-logit-mean",
        default=False,
        action="store_true",
    ...
    parser.add_argument("--force-min-lr", type=float, default=0.0,
    ...
    parser.add_argument("--torchcompile",
        action="store_true",
        default=False,
    ...
    parser.add_argument("--model-norm",
        type=str,
    ...
    parser.add_argument("--load-pretrained-state",
        default=False,
        action='store_true',
    ...
    parser.add_argument("--fsdp-cpu-offload",
        default=False,
        action="store_true",
        help="CPU offloading for FSDP and checkpoint saving. This does not work with gradient accumulation."
    )
    parser.add_argument("--fsdp-use-orig-params",
        default=False,
        action="store_true",
        help="Passed into the FSDP constructor. This does not work for OPT models. Enables param_groups for weight_decay."
    )
    parser.add_argument("--fsdp-amp",
        default=False,
        action="store_true",
        help="Use FullyShardedDataParallel for distributed training."
    )
    parser.add_argument("--fsdp-backward-prefetch",
        default=False,
        action="store_true",
    )
    parser.add_argument("--fsdp-hybrid",
        default=False,
        action="store_true",
    )
    parser.add_argument("--fsdp-checkpoint",
        default=False,
        action="store_true",
    )
    parser.add_argument("--fsdp-limit-all-gathers",
        default=False,
        action="store_true",
    )
    ...
    parser.add_argument("--average-coefficients",
        type=float,
        nargs="+",
        default=None,
        help=(
    ...
    parser.add_argument("--copy-codebase",
        default=False,
        action="store_true",
    ...
    parser.add_argument("--no-set-device-rank",
        default=False,
        action="store_true",
    ...
    parser.add_argument("--remote-sync-frequency",
        type=int,
        default=300,
        help="How frequently to sync to a remote directly if --remote-sync is not None.",
    )
    parser.add_argument("--remote-sync-protocol",
        choices=["s3", "fsspec"],
        default="s3",
        help="How to do the remote sync backup if --remote-sync is not None.",
    )
    parser.add_argument("--delete-previous-checkpoint",
        default=False,
        action="store_true",
        help="If true, delete previous checkpoint after storing a new one."
    )
    parser.add_argument("--distill-model",
        default=None,
        help='Which model arch to distill from, if any.'
    )
    parser.add_argument("--distill-pretrained",
        default=None,
    ...
    parser.add_argument("--rotary-old",
        action="store_true",
        default=False,
    ...
    #         print(f"Setting {name} to default value {val}.")
