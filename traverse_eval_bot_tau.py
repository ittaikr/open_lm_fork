    ...
    for exp in os.listdir(base_path):
        ...
        for sub_dir in os.listdir(exp_path): 
            ...
            if not os.path.isdir(sub_dir_path):
                ...
                # print("not os.path.isdir(sub_dir_path) is", not os.path.isdir(sub_dir_path))
                # print("results in sub_dir_path is", 'results' in sub_dir_path)
                continue
...
if __name__ == "__main__":
    flop_dir_to_traverse = "results"
    sweep_dir = "exps_sweep"
    original_dir = "exps"
    # dirs_to_traverse = [os.path.join(flop_dir_to_traverse, exp) for exp in os.listdir(flop_dir_to_traverse) if os.path.isdir(os.path.join(flop_dir_to_traverse, exp)) and 'test_flop' in exp]
    dirs_to_traverse = ["results"]
    # for exp in os.listdir(flop_dir_to_traverse):
    #     # print(exp)
    #     if os.path.isdir(os.path.join(flop_dir_to_traverse, exp)) and 'test_flop' in exp:
    #         dirs_to_traverse.append(os.path.join(flop_dir_to_traverse, exp))
    # print(dirs_to_traverse)
