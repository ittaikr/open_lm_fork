...
WANDB_MODE=offline
srun --cpu_bind=v --accel-bind=gn --threads-per-core=1 python -u -m open_lm.main --name "$2" --logs $LOGS --val-data "/p/fastdata/mmlaion/lmdata/rpj/shard_{00040319..00040338}.tar"  --config $1 